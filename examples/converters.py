...
async def ignore(ctx: commands.Context, target: typing.Union[selfcord.Member, selfcord.TextChannel]):
    ...
    # See: https://selfcordpy.readthedocs.io/en/latest/ext/commands/commands.html#typing-union
...
async def multiply(ctx: commands.Context, number: int, maybe: bool):
    ...
    # See: https://selfcordpy.readthedocs.io/en/latest/ext/commands/commands.html#bool
