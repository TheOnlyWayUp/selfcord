...
This is the documentation for selfcord.py-self, a library for Python to aid
in creating self-bots that utilise the Discord API.

Prerequisites
---------------

selfcord.py-self works with Python 3.8 or higher. Support for earlier versions of Python
is not provided.
...
To get voice support, you should use ``selfcord.py-self[voice]`` instead of ``selfcord.py``, e.g. ::
...
3. Use pip like usual:
    ...
    .. code-block:: shell
        ...
        $ pip install -U selfcord.py-self
...
selfcord.py revolves around the concept of :ref:`events <selfcord-api-events>`.
