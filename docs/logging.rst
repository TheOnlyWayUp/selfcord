...
*selfcord.py-self* logs errors and debug information via the :mod:`logging` python
...
selfcord as well as other libraries that use the ``logging`` module
...
example to write the logs to a file called ``selfcord.log`` instead of
